 ...
 */
ObjectTree getAllDbusObjects(const std::string& serviceRoot,
                             const std::string& interface,
                             const std::string& match);
 ...
 *  @param[in] match - Identifier for object.
 */
void deleteAllDbusObjects(const std::string& serviceRoot,
                          const std::string& interface,
                          const std::string& match = {});

namespace no_method_args
{
 ...
 *  @param[in] args - Method args(list of variant).
