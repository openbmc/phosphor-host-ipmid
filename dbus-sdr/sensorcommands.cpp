                              ...
                              std::vector<uint8_t>& recordData)
{
    ...
    else
    {
        ...
        data.header.recordIdMsb = recordID >> 8;
        data.header.recordIdLsb = recordID & 0xFF;
                              ...
                              get_sdr::SensorDataFullRecord& record)
{
    ...
    {
        get_sdr::body::setIdStrLen(FULL_RECORD_ID_STR_MAX_LENGTH,
                                   &(record.body));
    }
    else
    {
