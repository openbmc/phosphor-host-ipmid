...
void registerSensorFunctions()
{
    ...
    // <Platform Event>
    ipmi::registerHandler(priority, ipmi::netFnSensor,
    ...
    ipmi::registerHandler(
        priority, ipmi::netFnSensor, ipmi::sensor_event::cmdSetSensorThreshold,
    ...
    ipmi::registerHandler(
        priority, ipmi::netFnStorage, ipmi::storage::cmdGetSdrRepositoryInfo,
