                                 ...
                                 get_sdr::SensorDataFullRecord& record)
{
    ...
    std::array<std::pair<int, int>, 3> sixBitShiftValues = {
        {{0, 6}, {2, 4}, {4, 2}}};
    ...
    size_t maximum6bitEncodingChars = (sizeof(record.body.id_string) * 4) / 3;
...
#if FEATURE_SIX_BIT_ENCODE
    size_t id_string_len = createSixBitPackedSensorName(name, record);
