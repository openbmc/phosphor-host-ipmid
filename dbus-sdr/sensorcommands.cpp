                         ...
                         const std::string& path, std::bitset<16>& assertions)
{
    ...
    std::cerr << "base name is " << baseName << std::endl;
    auto readProperty = [&](std::string sdrPath, bool& value) {
        std::cerr << "read property " << sdrPath << std::endl;
        auto ec =
    ...
    std::cerr << "assert is " << assertions << std::endl;
}
