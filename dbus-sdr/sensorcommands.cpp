                                 ...
                                 get_sdr::SensorDataFullRecord& record)
{
    ...
    // always provide 4 chars to pack. Otherwise spaces will be packed, and
    // those are hard to see. Pack with visible characters.
    if (uint8_t missingChars = nameLength % 4; missingChars != 0)
    {
        tmpName.append(4 - missingChars, '_');
    }
