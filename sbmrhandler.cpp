...
{
    std::string stage = bootProgressOem;
    ...
    if (codeClass == efiSoftware)
    {
        ...
        {
            if (codeOperation == efiSwDxeCorePcHandoffToNext)
            {
                stage = bootProgressSystemInitComplete;
            }
        }
        else if (codeSubClass == efiSoftwareDxeBsDriver)
        {
            if (codeOperation == efiSwPcUserSetup)
            {
                stage = bootProgressSystemSetup;
            }
            else if (codeOperation == efiSwOsLoaderStart)
            {
                stage = bootProgressOsStart;
            }
        }
        else if (codeSubClass == efiSoftwareEfiBootService)
        {
            if (codeOperation == efiSwBsPcExitBootServices)
            {
                stage = bootProgressOsRuning;
            }
        }
    }
