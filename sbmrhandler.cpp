...
void updateBootProgressProperty(std::string prop)
{
    ...
    try
    {
        ...
        ipmi::setDbusProperty(*bus, sbmrHostStateService, sbmrHostStateObject,
                              sbmrHostStateInf, "BootProgress", bootProgress);
    }
...
void updateBootProgressLastUpdateProperty(uint64_t timeStamp)
{
    ...
    {
        ipmi::setDbusProperty(*bus, sbmrHostStateService, sbmrHostStateObject,
                              sbmrHostStateInf, "BootProgressLastUpdate",
                              timeStamp);
    }
    catch (const std::exception& e)
    {
    ...
    sendBootProgressCode(ipmi::Context::ptr ctx, std::vector<uint8_t> data)
{
    ...
    try
    {
        ...
        auto method =
            ctx->bus->new_method_call(sbmrBootStateService, sbmrBootStateObj,
