    ...
    *data_len = 0;
    ...
    if (req->sysACPIState & acpi_state::stateChanged)
    {
        ...
        if ((s <= static_cast<uint8_t>(acpi_state::PowerState::override)) ||
            (s == static_cast<uint8_t>(acpi_state::PowerState::legacyOn)) ||
            (s == static_cast<uint8_t>(acpi_state::PowerState::legacyOff)) ||
    ...
    if (req->devACPIState & acpi_state::stateChanged)
    {
        ...
        if ((s <= static_cast<uint8_t>(acpi_state::PowerState::s3D3)) ||
            (s == static_cast<uint8_t>(acpi_state::PowerState::unknown)) ||
            (s == static_cast<uint8_t>(acpi_state::PowerState::noChange)))
        {
            // valid input
