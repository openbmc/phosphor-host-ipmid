...
static constexpr size_t uuidHexLength = (2 * uuidBinaryLength);
static constexpr size_t uuidRfc4122Length = (uuidHexLength + 4);
...
{
    static constexpr auto uuidInterface = "org.openbmc.control.Chassis";
    ...
    try
    {
        ...
        ipmi::DbusObjectInfo objectInfo =
            ipmi::getDbusObject(*busPtr, uuidInterface);
