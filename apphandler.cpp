...
#define IPMI_DEVID_MANUFID_SIZE 3
#define IPMI_DEVID_PRODID_SIZE 2
                             ...
                             ipmi_data_len_t data_len, ipmi_context_t context)
{
    ...
    *data_len = sizeof(dev_id);
    ...
    memcpy(&dev_id.manuf_id, &devidinfo.Manufacturer_Id, IPMI_DEVID_MANUFID_SIZE);

    // Witherspoon's product ID is hardcoded to 4F42(ASCII 'OB').
    memcpy(&dev_id.prod_id, &devidinfo.Product_Id, IPMI_DEVID_PRODID_SIZE);
