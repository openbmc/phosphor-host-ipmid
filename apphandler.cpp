...
/** Alias SessionDetails to contain the optional information about an
 *        RMCP+ session.
 *
 *  @param userID - uint8 session user ID (0-15)
 *  @param privilege - uint8_t session privilege (0-5)
 ...
 */
using SessionDetails = std::tuple<uint8_t, uint8_t, uint4_t, uint4_t, uint32_t,
