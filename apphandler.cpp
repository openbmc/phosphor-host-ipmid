                        ...
                        std::vector<uint8_t> writeData)
{
    ...
    auto mode = ctx->bus->yield_method_call<std::variant<std::string>>(
        ctx->yield, ec, specialModeService, specialModeObjPath,
        "org.freedesktop.DBus.Properties", "Get", specialModeIntf,
        "SpecialMode");
