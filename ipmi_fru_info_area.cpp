...
static constexpr auto hexNo1          = "0x";
static constexpr auto hexNo2          = "0X";
...
static constexpr auto hexNoSize                = 0x2;
 ...
 * @param[in,out] fruAreaData FRU area data
 */
void preFormatProcessing(bool langCode, FruAreaData& fruAreaData)
{
    ...
    if (langCode)
    {
        fruAreaData.emplace_back(static_cast<uint8_t>(englishLanguageCode));
    }
}
 ...
 * @param[in,out] fruAreaData FRU area to add the manfufacture date
 */
void appendData(
