                               ...
                               struct i2c_rdwr_ioctl_data* msgset)
{
    ...
    {
        fprintf(stderr, "I2c::transfer minReplyLen=%zu?\n", minReplyLen);
    ...
    {
        auto* msg = &msgs[i];
        fprintf(stderr, "I2c::transfer msg[%zu]: %02x %04x %d\n", i, msg->addr,
                msg->flags, msg->len);
    }
#endif
    return IPMI_CC_OK;
                         ...
                         uint8_t* replyBuf, size_t* dataLen)
{
    ...
    *dataLen = 0;
    ...
    if (ioError < 0)
    {
        fprintf(stderr, "I2c::transfer I2C_RDWR ioError=%d?\n", ioError);
    ...
    for (size_t i = 0; i < req.numSteps; ++i)
    {
        ...
        if (step.isRead)
        {
            ...
            {
                fprintf(stderr, "I2c::transfer[%zu] replyLen=%zu?\n", i,
                        replyLen);
                return IPMI_CC_RESPONSE_ERROR; // Won't fit in response message
            }
