...
inline void set_entity_instance_number(uint8_t n, SensorDataFullRecordBody* body) {
...
inline void set_analog_data_format(uint8_t format, SensorDataFullRecordBody* body) {
