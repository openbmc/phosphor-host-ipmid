                                 ...
                                 ipmi_data_len_t data_len, ipmi_context_t context)
{
    ...
    get_sdr_info_resp_set_lun_present(0, &(resp->luns_and_dynamic_population));
    get_sdr_info_resp_set_lun_not_present(1, &(resp->luns_and_dynamic_population));
    get_sdr_info_resp_set_lun_not_present(2, &(resp->luns_and_dynamic_population));
    get_sdr_info_resp_set_lun_not_present(3, &(resp->luns_and_dynamic_population));
    get_sdr_info_resp_set_static_population(&(resp->luns_and_dynamic_population));
