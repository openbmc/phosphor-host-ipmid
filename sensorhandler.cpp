    ...
    ipmiSensorGetSensorReading(uint8_t sensorNum)
{
    ...
    try
    {
        ...
        return ipmi::responseSuccess(
            std::get<SensorReading>(getResponse),
            std::get<Reserved>(getResponse),
            std::get<ReadingState>(getResponse),
            std::get<ScanningState>(getResponse),
            std::get<AllEventMessageState>(getResponse),
            std::get<ThresholdLevelsStates>(getResponse),
            std::get<DiscreteReadingSensorStates>(getResponse)
        );
    }
