                               ...
                               ipmi_data_len_t data_len)
{
    ...
    get_sdr::key::set_flags(entity->second.isList, entity->second.isLinked,
                            &(record.key));
    record.key.entityId1 = entity->second.entityId1;
    record.key.entityInstance1 = entity->second.entityInstance1;

    /* Body */
    record.body.entityId2 = entity->second.entityId2;
    record.body.entityInstance2 = entity->second.entityInstance2;
    record.body.entityId3 = entity->second.entityId3;
    record.body.entityInstance3 = entity->second.entityInstance3;
    record.body.entityId4 = entity->second.entityId4;
    record.body.entityInstance4 = entity->second.entityInstance4;
