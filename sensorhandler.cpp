...
get_sdr::GetSensorThresholdsResponse getSensorThresholds(uint8_t sensorNum)
{
    ...
    try
    {
        ...
        auto warnLow = ipmi::mappedVariant<double>(
            warnThresholds, "WarningLow",
            std::numeric_limits<double>::quiet_NaN());
        auto warnHigh = ipmi::mappedVariant<double>(
    ...
    try
    {
        ...
        auto critLow = ipmi::mappedVariant<double>(
            critThresholds, "CriticalLow",
            std::numeric_limits<double>::quiet_NaN());
        auto critHigh = ipmi::mappedVariant<double>(
