...
inline ipmi::DbusObjectInfo getDbusObject(const std::string& interface,
                                          const std::string& serviceRoot,
                                          const std::string& match)
{
    std::vector<ipmi::DbusInterface>interfaces;
    ...
    if(match == "")
    {
        objectInfo =  std::make_pair(std::move(objectTree.begin()->first),
    ...
    for (auto& object : objectTree)
    {
        ...
        {
            objectFound = true;
            objectInfo = make_pair(std::move(object.first),
 ...
 */
inline ipmi::Value getDbusProperty(const std::string& service,
 ...
 */
inline ipmi::PropertyMap getAllDbusProperties(const std::string& service,
                                              const std::string& objPath,
                                              const std::string& interface)
{
...
inline void deleteAllDbusObject(const std::string& serviceRoot,
                                const std::string& interface,
                                const std::string& match)
{
    try
...
inline uint16_t getVLAN(const std::string& path)
{
