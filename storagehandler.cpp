    ...
    ipmiStorageGetSelInfo()
{
    ...
    constexpr uint8_t operationSupport = ipmi::sel::operationSupport;
    constexpr uint8_t operationSupportMask = 0x01;
    constexpr uint8_t operationSupportOne = 1;
    constexpr uint8_t operationSupportTwo = 2;
    constexpr uint8_t operationSupportThree = 3;
    constexpr uint8_t operationSupportSeven = 7;
    constexpr bool selAllocInfoSuppFlag =
        static_cast<bool>(operationSupport & operationSupportMask);
    constexpr bool reserveSelSuppFlag = static_cast<bool>(
        (operationSupport >> operationSupportOne) & operationSupportMask);
    constexpr bool addSelSupportFlag = static_cast<bool>(
        (operationSupport >> operationSupportTwo) & operationSupportMask);
    constexpr bool deleteSelSupportFlag = static_cast<bool>(
        (operationSupport >> operationSupportThree) & operationSupportMask);
    constexpr uint3_t reserved{0};
    constexpr bool overflowFlag = static_cast<bool>(
        (operationSupport >> operationSupportSeven) & operationSupportMask);

    return ipmi::responseSuccess(selVersion, entries, freeSpace, addTimeStamp,
                                 eraseTimeStamp, selAllocInfoSuppFlag,
                                 reserveSelSuppFlag, addSelSupportFlag,
