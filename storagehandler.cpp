    ...
    ipmiStorageGetSelInfo()
{
    ...
    constexpr bool selAllocInfoSuppFlag =
        static_cast<bool>(operationSupport & 0x01);
    constexpr bool ReserveSelSuppFlag =
        static_cast<bool>((operationSupport >> 1) & 0x01);
    constexpr bool addSelSupportFalg =
        static_cast<bool>((operationSupport >> 2) & 0x01);
    constexpr bool deleteSelSupportFlag =
        static_cast<bool>((operationSupport >> 3) & 0x01);
    constexpr uint3_t reserved{0};
    constexpr bool overflowFlag =
        static_cast<bool>((operationSupport >> 7) & 0x01);
