    ...
    ipmiGetRepositoryInfo()
{
    ...
    static constexpr uint8_t sdrVersion = 0x51;
    static constexpr uint16_t freeSpace = 0xFFFF;
    static constexpr uint32_t additionTimestamp = 0x0;
    static constexpr uint32_t deletionTimestamp = 0x0;
    static constexpr uint8_t operationSupport = 0;
