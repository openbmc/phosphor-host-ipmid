    ...
    ipmiStorageGetSelInfo()
{
    ...
    constexpr bool reserveSelSuppFlag = ipmi::sel::operationSupport::reserveSel;
    constexpr bool addSelSupportFlag =
        ipmi::sel::operationSupport::partialAddSelEntry;
    constexpr bool deleteSelSupportFlag =
        ipmi::sel::operationSupport::deleteSel;
    constexpr uint3_t reserved{0};
    constexpr bool overflowFlag = ipmi::sel::operationSupport::overflow;
