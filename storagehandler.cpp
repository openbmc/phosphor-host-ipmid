...
ipmi::RspType<uint8_t,  // SEL revision.
              ...
              uint1_t, // SEL allocation info supported
              uint1_t, // reserve SEL supported
              uint1_t, // add SEL supported
              uint1_t, // delete SEL supported
              uint3_t, // reserved
              uint1_t  // overflow flag
              >
    ipmiStorageGetSelInfo()
{
    ...
    static constexpr uint8_t operationSupportMask = 0x01;
    static constexpr uint8_t reserveSelMask = 0x07;
    static constexpr uint8_t OperationReserveSelMask = 1;
    static constexpr uint8_t addSelSupportMask = 2;
    static constexpr uint8_t deleteSelSupportMask = 3;
    static constexpr uint8_t reservedMask = 4;
    static constexpr uint8_t overflowFlagMask = 7;
    ...
    return ipmi::responseSuccess(
        ...
        static_cast<uint1_t>(
            (ipmi::sel::operationSupport)&operationSupportMask),
        static_cast<uint1_t>(
            (ipmi::sel::operationSupport >> OperationReserveSelMask) &
            operationSupportMask),
        static_cast<uint1_t>(
            (ipmi::sel::operationSupport >> addSelSupportMask) &
            operationSupportMask),
        static_cast<uint1_t>(
        ...
        static_cast<uint3_t>((ipmi::sel::operationSupport >> reservedMask) &
                             reserveSelMask),
        static_cast<uint1_t>((ipmi::sel::operationSupport >> overflowFlagMask) &
                             operationSupportMask));
}
...
{
    return ipmi::responseSuccess(static_cast<uint16_t>(reserveSel()));
}
