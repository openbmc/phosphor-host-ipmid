...
const char *time_manager_intf = "org.openbmc.TimeManager";
const char *time_manager_obj = "/org/openbmc/TimeManager";
                              ...
                              ipmi_data_len_t data_len, ipmi_context_t context)
{
    ...
    rct = mapper_get_service(bus, time_manager_obj, &time_provider);
    if (rct < 0) {
