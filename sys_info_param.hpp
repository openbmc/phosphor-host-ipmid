...
static constexpr uint16_t maxBytesPerParameter = 256;
...
class SysInfoParamStoreIntf
{
  public:
     ...
     */
    virtual std::tuple<bool, IpmiSysInfo>
...
{
  public:
    std::tuple<bool, IpmiSysInfo> lookup(uint8_t paramSelector) const override;
