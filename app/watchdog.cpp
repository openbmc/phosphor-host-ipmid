...
/** @enum TimerUse
 *
 * @brief These bits are defined by the IPMI spec to set what
...
/**
 * @brief The structure used for the set watchdog command,
 * and is part of the get watchdog response.
 */
struct wd_data_t {
    uint8_t timer_use;
...
/**
 * @brief The structure used for the response to the get watchdog command.
 */
...
static constexpr auto timeout_action_mask = 0x07;
        ...
        ipmi_context_t context)
{
    ...
    *data_len = 0;
     ...
     */
    if ((reqptr->timer_action & timeout_action_mask) ==
        ...
        ipmi_context_t context)
{
    ...
    *data_len = 0;
    ...
    if (enabled)
    {
        ...
        //
        data->config.timer_action |= static_cast<uint8_t>(
                TimeoutAction::HARD_RESET);
    }
