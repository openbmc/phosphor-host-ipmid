        ...
        ipmi_context_t context)
{
    ...
    *data_len = 0;
    ...
    std::string watchdogService = ipmi::getService(
            bus, WATCHDOG_INTF, WATCHDOG_PATH);
    ...
    bool enabled = sdbusplus::message::variant_ns::get<bool>(
            propMap["Enabled"]);
    uint64_t timeRemaining = sdbusplus::message::variant_ns::get<uint64_t>(
            propMap["TimeRemaining"]);
    uint64_t interval = sdbusplus::message::variant_ns::get<uint64_t>(
            propMap["Interval"]);
