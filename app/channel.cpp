...
/** @brief this command is used to look up authentication, integrity,
 *  confidentiality algorithms are support.
 *
 ...
 *  - rspChannel - Channel Number related authentication algorithm.
