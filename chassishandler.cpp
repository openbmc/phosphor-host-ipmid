...
static constexpr auto POHCounter = "POHCounter";
...
uint32_t getPOHCounter()
{
    ...
    auto propValue = ipmi::getDbusProperty(bus, service, chassisStateObj.first,
                                           chassisPOHStateIntf, POHCounter);
                                ...
                                ipmi_data_len_t data_len, ipmi_context_t context)
{
    ...
    auto resptr = reinterpret_cast<GetPOHCoutResponse*>(response);
    ...
    *data_len = sizeof(GetPOHCoutResponse);
