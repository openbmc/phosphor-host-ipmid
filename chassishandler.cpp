                                             ...
                                             ipmi::message::Payload& data)
{
    ...
    if (parameterSelector == static_cast<uint7_t>(BootOptionParameter::bootFlags))
    {
        uint5_t rsvd;
        bool validFlag;
        bool permanent;
        ...
        if (data.unpack(rsvd, biosBootType, permanent, validFlag, bootOpn,
                        bootDevice, biosInfo, rsvd1, deviceInstance, rsvd2) != 0 ||
            !data.fullyUnpacked())
        {
