...
static constexpr auto chassisCapFlagsProp = "CapabilitiesFlags";
static constexpr auto chassisFRUDevAddrProp = "FRUDeviceAddress";
static constexpr auto chassisSDRDevAddrProp = "SDRDeviceAddress";
static constexpr auto chassisSELDevAddrProp = "SELDeviceAddress";
static constexpr auto chassisSMDevAddrProp = "SMDeviceAddress";
static constexpr auto chassisBridgeDevAddrProp = "BridgeDeviceAddress";
                                ...
                                ipmi_context_t context)
{
    ...
    *data_len = 0;
    ...
    {
        log<level::ERR>("Unsupported request parameter(cap_flags)",
    ...
    {
        log<level::ERR>("Unsupported request parameter(fru_addr)",
    ...
    {
        log<level::ERR>("Unsupported request parameter(sdr_addr)",
    ...
    {
        log<level::ERR>("Unsupported request parameter(sel_addr)",
    ...
    {
        log<level::ERR>(
            "Unsupported request parameter(sm_addr)",
    ...
    {
        log<level::ERR>("Unsupported request parameter(bridge_addr)",
