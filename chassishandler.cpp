...
{
    constexpr const char* nmiObjPath = "/xyz/openbmc_project/control/host0/nmi";
    ...
    auto nmiCall = chassis::internal::dbus.new_method_call(
        service.c_str(), nmiObjPath, nmiIntfName, "NMI");
    try
    {
