                                          ...
                                          ipmi_context_t context)
{
    ...
    {
        *data_len = 0;
        logging::log<level::ERR>("IPMI request len is invalid");
        return IPMI_CC_REQ_DATA_LEN_INVALID;
    }
    *data_len = 0;
    ...
    {
        logging::log<level::ERR>(e.what());
        logging::log<level::ERR>("Fail to set power button Enabled property");
    }
    ...
    {
        logging::log<level::ERR>(e.what());
        logging::log<level::ERR>("Fail to set reset button Enabled property");
    }
