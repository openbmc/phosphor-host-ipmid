                                   ...
                                   ipmi_context_t context)
{
    ...
    auto method = dbus.new_method_call(
                      powerRestoreSetting.second.c_str(),
                      powerRestoreSetting.first.c_str(),
                      PROP_INTF,
                      "Get");
                                             ...
                                             ipmi_context_t context)
{
    ...
    ( BootOptionParameter::BOOT_FLAGS )) {
        ...
        *data_len = static_cast<uint8_t>(BootOptionResponseSize::BOOT_FLAGS);
        ...
        auto method = bus.new_method_call(
                          bootSourceSetting.second.c_str(),
                          bootSourceSetting.first.c_str(),
                          PROP_INTF,
                          "Get");
        ...
        method = bus.new_method_call(
                     bootModeSetting.second.c_str(),
                     bootModeSetting.first.c_str(),
                     PROP_INTF,
                      "Get");
