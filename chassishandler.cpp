...
ipmi::RspType<bool,    // Power is on
              ...
              bool, // 1b = Power off button disabled
              bool, // 1b = Reset button disabled
              bool, // 1b = Diagnostic Interrupt button disabled
              bool, // 1b = Standby (sleep) button disabled
              bool, // 1b = Power off button disable allowed
              bool, // 1b = Reset button disable allowed
              bool, // 1b = Diagnostic Interrupt button disable allowed
              bool  // 1b = Standby (sleep) button disable allowed
              >
