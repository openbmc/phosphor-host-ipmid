...
bool getDHCPProperty(std::string prop)
{
    sdbusplus::bus::bus bus{ ipmid_get_sd_bus_connection() };
...
void setDHCPProperty(std::string prop, bool value)
{
    sdbusplus::bus::bus bus{ ipmid_get_sd_bus_connection() };
                             ...
                             ipmi_data_len_t data_len, ipmi_context_t context)
{
    ...
    *data_len = 0;
    ...
    try
    {
        auto enableDHCP = dcmi::getDHCPEnabled();
        auto enabledHCPOpt12 = dcmi::getDHCPProperty("dHCPOpt12Enabled");
        auto enabledHCPOpt60Opt43 = dcmi::getDHCPProperty(
        ...
        switch (requestData->paramSelect)
        {
            ...
            case dcmi::DCMI_CONFIG_PARAMS::DCMI_DISCOVER_CONFIG:
                    ...
                    dcmi::DCMI_CONFIG_PARAMS::DCMI_OPTION_12_MASK)
                {
                    if (!enabledHCPOpt12)
                    {
                        dcmi::setDHCPProperty("dHCPOpt12Enabled", true);
                    }
                ...
                else
                {
                    if (enabledHCPOpt12)
                    {
                        dcmi::setDHCPProperty("dHCPOpt12Enabled", false);
                    }
                    ...
                    dcmi::DCMI_CONFIG_PARAMS::DCMI_OPTION_60_43_MASK)
                {
                    ...
                    {
                        dcmi::setDHCPProperty("dHCPOpt60Opt43Enabled", true);
                    }
                }
                else
                {
                    if (enabledHCPOpt60Opt43)
                    {
                        dcmi::setDHCPProperty("dHCPOpt60Opt43Enabled", false);
                    }
                }
    ...
    *data_len = 0;
    ...
    try
    {
        ...
        switch (requestData->paramSelect)
        {
            ...
            case dcmi::DCMI_CONFIG_PARAMS::DCMI_DHCP_TIMING1:
                responseData->data[0] = 0x04; // 4 sec
                *data_len = sizeof(dcmi::GetConfParamsResponse) + 1;
                break;
            case dcmi::DCMI_CONFIG_PARAMS::DCMI_DHCP_TIMING2:
                responseData->data[0] = 0x78; // 2 min
                responseData->data[1] = 0x00;
                *data_len = sizeof(dcmi::GetConfParamsResponse) + 2;
                break;
            case dcmi::DCMI_CONFIG_PARAMS::DCMI_DHCP_TIMING3:
                responseData->data[0] = 0x40; // 64 sec
                responseData->data[1] = 0x00;
                *data_len = sizeof(dcmi::GetConfParamsResponse) + 2;
                break;
            default:
