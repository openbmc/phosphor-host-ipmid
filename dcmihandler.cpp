                    ...
                    uint8_t reserved)
{
    ...
    if ((mode > dcmi::DCMIPowerReadingMode::modeEnhancedPowerStats) || reserved)
    {
    ...
    return ipmi::responseSuccess(currentPower, totalPower, totalPower,
                                 totalPower, timeStamp, timeFrame,
                                 powerReadingState);
}
