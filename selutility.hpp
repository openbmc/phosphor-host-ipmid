...
/** @struct GetSELEntryResponseTyped
 *
 *  IPMI payload for Get SEL Entry command response for all record types.
 */
struct GetSELEntryResponseTyped
{
...
/** @struct AddSELEntryRequestTyped
 *
 *  IPMI payload for Add SEL Entry command request for all record types.
 */
struct AddSELEntryRequestTyped
{
    uint16_t recordID;
