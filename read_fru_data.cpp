...
constexpr auto INVENTORY_SETTINGS_CHANGE =
        ...
        "path_namespace='/xyz/openbmc_project/inventory',member='PropertiesChanged'";
...
int registerFruPropertyChangeHandle()
{
    ...
    r = sd_bus_add_match(bus, NULL, INVENTORY_SETTINGS_CHANGE, processFruPropChange, &gfrusMap);
    if (r < 0)
    {
