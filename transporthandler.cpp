 ...
 *  @return An address representing the gateway address
 */
AnyAddr getGatewayProperty(sdbusplus::bus::bus& bus,
                                 ...
                                 uint8_t block)
{
    ...
    switch (static_cast<LanParam>(parameter))
    {
        ...
        {
            in_addr gateway = std::get<in_addr>(
                channelCall<getGatewayProperty>(channel, AF_INET));
