                                  ...
                                  ipmi_context_t context)
{
    ...
    *data_len = 0;
    ...
    char ipv6saddr[ipmi::network::IPV6_STATIC_ADDRESS_SIZE_BYTE];
    ...
    switch (static_cast<LanParam>(reqptr->parameter))
    {
        ...
        // case LanParam::GATEWAY_MAC:
        {
            ...
            const char* intf =
                (static_cast<LanParam>(reqptr->parameter) == LanParam::MAC)
                ? ipmi::network::MAC_INTERFACE
                : ipmi::network::NEIGHBOR_INTERFACE;
        ...
        case LanParam::IPV6_STATIC_ADDRESSES:
        {
            ...
            *data_len += 2;
            std::snprintf(ipv6saddr + *data_len, INET6_ADDRSTRLEN,
