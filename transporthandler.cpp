        ...
        switch (lan_param)
        {
            ...
            case LAN_PARM_VLAN:
            {
                ...
                else if (lan_set_in_progress == SET_IN_PROGRESS)
                {
                    ...
                    //no interested in 16th bit.
                    channelConfig.vlanID = channelConfig.vlanID & vlanIDMask;
                                  ...
                                  ipmi_context_t context)
{
    ...
    *data_len = 0;
    ...
    auto reqptr = reinterpret_cast<set_lan_t*>(request);
