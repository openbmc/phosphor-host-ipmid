...
enum class LanParam : uint8_t
{
    ...
    IPV6_STATIC_ROUTER_2_IP_ADDR = 68, // Why is its number the same?
    IPV6_STATIC_ROUTER_2_MAC_ADDR = 69,
    IPV6_STATIC_ROUTER_2_PREFIX_LEN = 70,
    IPV6_STATIC_ROUTER_2_PREFIX_VAL = 71,
    DYNAMIC_ROUTER_INFO_SET_COUNT = 72,       // Read-only
    IPV6_DYNAMIC_ROUTER_INFO_IP_ADDR = 73,    // Read-only
    IPV6_DYNAMIC_ROUTER_INFO_MAC = 74,        // Read-only
    IPV6_DYNAMIC_ROUTER_INFO_PREFIX_LEN = 75, // Read-only
    IPV6_DYNAMIC_ROUTER_INFO_PREFIX_VAL = 76, // Read-only
    IPV6_DYNAMIC_ROUTER_RECV_HOP_LIMIT = 77,
    IPV6_NEIGHBOR_TIMING_CONF_SUPPORT = 78, // Read-only
    IPV6_NEIGHBOR_TIMING_CONFIGURATION = 79,
};
