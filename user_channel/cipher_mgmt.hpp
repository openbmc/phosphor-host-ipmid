 ...
 * default parameter is csPrivFileName
 *  @param[in] csDefaultFileName - default cipher suite privile file name,
 * default paramter is csPrivDefaultFileName
 *
 *  @return static CipherConfig object
 */
CipherConfig& getCipherConfigObject(
    const std::string& csFileName = csPrivFileName,
    const std::string& csDefaultFileName = csPrivDefaultFileName);
} // namespace ipmi
