...
{
    static constexpr uint8_t ENABLE = 0x0;
    static constexpr uint8_t DISABLE = 0x1;
...
void UserAccess::readUserData()
{
    ...
    std::vector<bool> payloadAccessDefault(ipmiMaxChannels, false);
    ...
    for (size_t usrIndex = 1; usrIndex <= ipmiMaxUsers; ++usrIndex)
    {
        ...
        std::vector<bool> stdPayload1SOL =
            payloadEnabled[jsonStdPayload1SOL].get<std::vector<bool>>();
        std::vector<bool> stdPayload2 =
            payloadEnabled[jsonStdPayload2].get<std::vector<bool>>();
        std::vector<bool> stdPayload3 =
            payloadEnabled[jsonStdPayload3].get<std::vector<bool>>();
        std::vector<bool> stdPayload4 =
            payloadEnabled[jsonStdPayload4].get<std::vector<bool>>();
        std::vector<bool> stdPayload5 =
            payloadEnabled[jsonStdPayload5].get<std::vector<bool>>();
        std::vector<bool> stdPayload6 =
            payloadEnabled[jsonStdPayload6].get<std::vector<bool>>();
        std::vector<bool> stdPayload7 =
            payloadEnabled[jsonStdPayload7].get<std::vector<bool>>();

        std::vector<bool> oemPayload0 =
            payloadEnabled[jsonOEMPayload0].get<std::vector<bool>>();
        std::vector<bool> oemPayload1 =
            payloadEnabled[jsonOEMPayload1].get<std::vector<bool>>();
        std::vector<bool> oemPayload2 =
            payloadEnabled[jsonOEMPayload2].get<std::vector<bool>>();
        std::vector<bool> oemPayload3 =
            payloadEnabled[jsonOEMPayload3].get<std::vector<bool>>();
        std::vector<bool> oemPayload4 =
            payloadEnabled[jsonOEMPayload4].get<std::vector<bool>>();
        std::vector<bool> oemPayload5 =
            payloadEnabled[jsonOEMPayload5].get<std::vector<bool>>();
        std::vector<bool> oemPayload6 =
            payloadEnabled[jsonOEMPayload6].get<std::vector<bool>>();
        std::vector<bool> oemPayload7 =
            payloadEnabled[jsonOEMPayload7].get<std::vector<bool>>();
        ...
        for (size_t chIndex = 0; chIndex < ipmiMaxChannels; ++chIndex)
        {
            ...
            // Set other values from parsed values of JSON file.
...
void UserAccess::writeUserData()
{
    ...
    for (size_t usrIndex = 1; usrIndex <= ipmiMaxUsers; ++usrIndex)
    {
        ...
        std::vector<bool> stdPayload1SOL(ipmiMaxChannels);
        std::vector<bool> stdPayload2(ipmiMaxChannels);
        std::vector<bool> stdPayload3(ipmiMaxChannels);
        std::vector<bool> stdPayload4(ipmiMaxChannels);
        std::vector<bool> stdPayload5(ipmiMaxChannels);
        std::vector<bool> stdPayload6(ipmiMaxChannels);
        std::vector<bool> stdPayload7(ipmiMaxChannels);

        std::vector<bool> oemPayload0(ipmiMaxChannels);
        std::vector<bool> oemPayload1(ipmiMaxChannels);
        std::vector<bool> oemPayload2(ipmiMaxChannels);
        std::vector<bool> oemPayload3(ipmiMaxChannels);
        std::vector<bool> oemPayload4(ipmiMaxChannels);
        std::vector<bool> oemPayload5(ipmiMaxChannels);
        std::vector<bool> oemPayload6(ipmiMaxChannels);
        std::vector<bool> oemPayload7(ipmiMaxChannels);
