...
bool pamUserCheckAuthenticate(const std::string& username, const std::string& password)
{
    const struct pam_conv localConversation = {pamFunctionConversation,
    ...
    if (pam_start("dropbear", username.c_str(), &localConversation, &localAuthHandle) !=
        PAM_SUCCESS)
    {
