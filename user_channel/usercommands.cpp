    ...
    uint8_t oemPayloadEnables2Reserved)
{
    ...
    payloadAccess.stdPayloadEnables1[2] = stdPayload2;
    payloadAccess.stdPayloadEnables1[3] = stdPayload3;
    payloadAccess.stdPayloadEnables1[4] = stdPayload4;
    payloadAccess.stdPayloadEnables1[5] = stdPayload5;
    payloadAccess.stdPayloadEnables1[6] = stdPayload6;
    payloadAccess.stdPayloadEnables1[7] = stdPayload7;
                             ...
                             uint6_t userId, uint2_t reserved2)
{
    ...
    // Cast to 'bool' as bitset [] operator returns a reference.
    return ipmi::responseSuccess(
