 ...
 *
 *  Structure for set channel access request command
 */
struct setChannelAccessReq
{
 ...
 *
 *  Structure for get channel access request command
 */
struct getChannelAccessReq
{
#if BYTE_ORDER == LITTLE_ENDIAN
 ...
 *
 *  Structure for get channel access response command
 */
struct getChannelAccessResp
{
#if BYTE_ORDER == LITTLE_ENDIAN
 ...
 *
 *  Structure for get channel info request command
 */
struct getChannelInfoReq
{
#if BYTE_ORDER == LITTLE_ENDIAN
 ...
 *
 *  Structure for get channel info response command
 */
struct getChannelInfoResp
{
#if BYTE_ORDER == LITTLE_ENDIAN
