...
{
  public:
    /** Constructs a UserManagerObject object.
     * @see UserManagerService.addUserManagerObject()
     */
...
{
  public:
    /** Constructs a UserObject object.
     * @see UserManagerService.addUserObject()
     */
...
class UserManagerService : public MockService
{
  public:
    ...
    /** Adds a new UserManagerObject object to this service.
     *
    ...
    void addUserManagerObject(const std::string& objectPath,
                              const UserManagerProperties& vals);
    /** Adds a new UserObject object to this service.
     *
     * @param objectPath - The path of the object on D-Bus.
     * @param vals - initial interface values.
     */
