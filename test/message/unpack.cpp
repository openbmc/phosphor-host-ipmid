...
TEST(Uints, Int8InsufficientBytes)
{
...
TEST(Uints, Int16InsufficientBytes)
{
    std::vector<uint8_t> i = {0x04};
    ipmi::message::Payload p(i);
    uint16_t v = 0;
...
TEST(Uints, Int32InsufficientBytes)
{
    std::vector<uint8_t> i = {0x04, 0x86, 0x00};
    ipmi::message::Payload p(i);
    uint32_t v = 0;
...
TEST(Uints, Int64InsufficientBytes)
{
...
TEST(FixedInts, Int24TooManyBytes)
{
...
TEST(FixedInts, Int24InsufficientBytes)
{
