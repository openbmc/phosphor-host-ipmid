...
int SoftPowerOff::hostControlSignalRcv(sd_bus_message* msg,
                                       void* userData,
                                       sd_bus_error* retError)
{
    return static_cast<SoftPowerOff*>(userData)->hostControl(msg, retError);
}

// Function called on host control signals
int SoftPowerOff::hostControl(sd_bus_message* msg,
                              sd_bus_error* retError)
{
