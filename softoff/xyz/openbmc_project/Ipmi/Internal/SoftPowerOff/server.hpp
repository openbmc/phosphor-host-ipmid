...
class SoftPowerOff
{
    public:
        ...
        /** Get value of Initiate */
        virtual bool initiate() const;
        /** Set value of Initiate */
        virtual bool initiate(bool value);
    ...
    private:
        ...
        /** @brief sd-bus callback for get-property 'Initiate' */
        static int _callback_get_Initiate(
            sd_bus*, const char*, const char*, const char*,
            sd_bus_message*, void*, sd_bus_error*);
        /** @brief sd-bus callback for set-property 'Initiate' */
        static int _callback_set_Initiate(
            sd_bus*, const char*, const char*, const char*,
            sd_bus_message*, void*, sd_bus_error*);
