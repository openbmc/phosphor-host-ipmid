...
auto SoftPowerOff::initiate() const ->
        bool
{
    return _initiate;
}

int SoftPowerOff::_callback_get_Initiate(
        ...
        sd_bus_error* error)
{
    ...
    try
    {
        ...
        m.append(convertForMessage(o->initiate()));
    }
...
auto SoftPowerOff::initiate(bool value) ->
        bool
{
    if (_initiate != value)
    {
        _initiate = value;
        _xyz_openbmc_project_Ipmi_Internal_SoftPowerOff_interface.property_changed("Initiate");
    }

    return _initiate;
}

int SoftPowerOff::_callback_set_Initiate(
        sd_bus* bus, const char* path, const char* interface,
...
{
static const auto _property_Initiate =
...
static const std::tuple<const char*, SoftPowerOff::HostResponse> mappingSoftPowerOffHostResponse[] =
        {
            ...
            std::make_tuple( "xyz.openbmc_project.Ipmi.Internal.SoftPowerOff.HostResponse.PartitionsShutdown",                 SoftPowerOff::HostResponse::PartitionsShutdown ),
...
const vtable::vtable_t SoftPowerOff::_vtable[] = {
    vtable::start(),
    vtable::property("Initiate",
                     details::SoftPowerOff::_property_Initiate
                        .data(),
                     _callback_get_Initiate,
                     _callback_set_Initiate,
