...
namespace example::xyz::openbmc_project::Example::Elog
{
using TestErrorTwo = phosphor::logging::example::xyz::openbmc_project::example::
    elog::TestErrorTwo;
}
#endif
...
struct TestCallout : public sdbusplus::exception_t
{
    ...
    using CALLOUT_ERRNO_TEST = phosphor::logging::example::xyz::
        openbmc_project::example::device::Callout::CALLOUT_ERRNO_TEST;
    using CALLOUT_DEVICE_PATH_TEST = phosphor::logging::example::xyz::
        openbmc_project::example::device::Callout::CALLOUT_DEVICE_PATH_TEST;
    using metadata_types =
...
namespace example::xyz::openbmc_project::Example::Elog
{
using TestCallout = phosphor::logging::example::xyz::openbmc_project::example::
    elog::TestCallout;
}
#endif
...
struct TestErrorOne : public sdbusplus::exception_t
{
    ...
    using DEV_ADDR = phosphor::logging::example::xyz::openbmc_project::example::
        elog::TestErrorTwo::DEV_ADDR;
    using DEV_ID = phosphor::logging::example::xyz::openbmc_project::example::
        elog::TestErrorTwo::DEV_ID;
    using DEV_NAME = phosphor::logging::example::xyz::openbmc_project::example::
        elog::TestErrorTwo::DEV_NAME;
    using metadata_types =
...
namespace example::xyz::openbmc_project::Example::Elog
{
using TestErrorOne = phosphor::logging::example::xyz::openbmc_project::example::
    elog::TestErrorOne;
}
#endif
...
namespace example::xyz::openbmc_project::Example::Foo
{
using Foo = phosphor::logging::example::xyz::openbmc_project::example::foo::Foo;
}
#endif
...
struct Bar : public sdbusplus::exception_t
{
    ...
    using FOO_DATA = phosphor::logging::example::xyz::openbmc_project::example::
        foo::Foo::FOO_DATA;
    using ERRNUM = phosphor::logging::example::xyz::openbmc_project::example::
        elog::TestErrorOne::ERRNUM;
    using FILE_PATH = phosphor::logging::example::xyz::openbmc_project::
...
namespace example::xyz::openbmc_project::Example::Bar
{
using Bar = phosphor::logging::example::xyz::openbmc_project::example::bar::Bar;
}
#endif
