...
{
    static constexpr auto errName = "example.xyz.openbmc_project.Example2.Device.Callout";
...
{
    static constexpr auto errName = "example.xyz.openbmc_project.Example2.Elog.TestErrorTwo";
...
{
using TestErrorTwo =
    phosphor::logging::example::xyz::openbmc_project::example2::elog::TestErrorTwo;
}
#endif
...
{
    static constexpr auto errName = "example.xyz.openbmc_project.Example2.Elog.AutoTestSimple";
...
using AutoTestSimple =
    phosphor::logging::example::xyz::openbmc_project::example2::elog::AutoTestSimple;
}
#endif
...
{
    static constexpr auto errName = "example.xyz.openbmc_project.Example2.Elog.TestCallout";
    static constexpr auto errDesc = "This is test error TestCallout";
    static constexpr auto L = level::ERR;
    using DEV_ADDR = _TestCallout::DEV_ADDR;
    using CALLOUT_ERRNO_TEST =
        phosphor::logging::example::xyz::openbmc_project::example2::device::Callout::CALLOUT_ERRNO_TEST;
    using CALLOUT_DEVICE_PATH_TEST =
        phosphor::logging::example::xyz::openbmc_project::example2::device::Callout::CALLOUT_DEVICE_PATH_TEST;
...
{
using TestCallout =
    phosphor::logging::example::xyz::openbmc_project::example2::elog::TestCallout;
}
#endif
...
{
    static constexpr auto errName = "example.xyz.openbmc_project.Example2.Elog.TestErrorOne";
    ...
    using DEV_ADDR =
        phosphor::logging::example::xyz::openbmc_project::example2::elog::TestErrorTwo::DEV_ADDR;
    using DEV_ID =
        phosphor::logging::example::xyz::openbmc_project::example2::elog::TestErrorTwo::DEV_ID;
    using DEV_NAME =
        phosphor::logging::example::xyz::openbmc_project::example2::elog::TestErrorTwo::DEV_NAME;
...
{
using TestErrorOne =
    phosphor::logging::example::xyz::openbmc_project::example2::elog::TestErrorOne;
}
#endif
...
{
    static constexpr auto errName = "example.xyz.openbmc_project.Example2.Foo.Foo";
    static constexpr auto errDesc = "this is test error Foo";
    static constexpr auto L = level::INFO;
    using FOO_DATA = _Foo::FOO_DATA;
    using ERRNUM =
        phosphor::logging::example::xyz::openbmc_project::example2::elog::TestErrorOne::ERRNUM;
    using FILE_PATH =
        phosphor::logging::example::xyz::openbmc_project::example2::elog::TestErrorOne::FILE_PATH;
    using FILE_NAME =
        phosphor::logging::example::xyz::openbmc_project::example2::elog::TestErrorOne::FILE_NAME;
    using DEV_ADDR =
        phosphor::logging::example::xyz::openbmc_project::example2::elog::TestErrorTwo::DEV_ADDR;
    using DEV_ID =
        phosphor::logging::example::xyz::openbmc_project::example2::elog::TestErrorTwo::DEV_ID;
...
{
    static constexpr auto errName = "example.xyz.openbmc_project.Example2.Bar.Bar";
    static constexpr auto errDesc = "this is test error Bar";
    static constexpr auto L = level::INFO;
    using BAR_DATA = _Bar::BAR_DATA;
    using FOO_DATA =
        phosphor::logging::example::xyz::openbmc_project::example2::foo::Foo::FOO_DATA;
    using ERRNUM =
        phosphor::logging::example::xyz::openbmc_project::example2::elog::TestErrorOne::ERRNUM;
    using FILE_PATH =
        phosphor::logging::example::xyz::openbmc_project::example2::elog::TestErrorOne::FILE_PATH;
